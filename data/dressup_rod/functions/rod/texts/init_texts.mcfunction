...
# Armor.material
data modify storage dressup_rod: texts.item set value [{text:"{\"text\":\"leather\",\"color\":\"gold\"}",id:0},{text:"{\"text\":\"golden\",\"color\":\"yellow\"}",id:1},{text:"{\"text\":\"chainmail\",\"color\":\"gray\"}",id:2},{text:"{\"text\":\"iron\",\"color\":\"white\"}",id:3},{text:"{\"text\":\"diamond\",\"color\":\"aqua\"}",id:4},{text:"{\"text\":\"netherite\",\"color\":\"dark_purple\"}",id:5}]
